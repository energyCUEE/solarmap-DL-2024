...
option_Ihat1=I # Iclr, Inwp, I_LGBM, Ireg ,if I_LGBM -->  num_features = 11
m2_name=Informer
folder_data=true_cloud_relation
checkpoints=checkpoints_true_cloud_relation_pt1

# for d_model in 64 128; do
#     for e_layer in 1 5 10; do
for e_layer in 2; do
    for d_model in 16 64 128; do
