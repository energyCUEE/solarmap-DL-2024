...
feature_type=MS
num_features=10  # len(features_list) -1 --> I_LGBM, Ireg = 11, I_nwp = 10, Iclr = 10
d_model=64 
e_layer=2
embed_type=2
moving_avg=4
num_features_overlap=1 # num_features_overlap = 1 (Iclr, Inwp), num_features_overlap = 2 (I_LGBM, Ireg)

# option_Ihat1=Iclr # Iclr, Inwp, I_LGBM, Ireg
m2_name=Informer
folder_data=solarmap
checkpoints=checkpoints_solarmap

for option_Ihat1 in Iclr; do
