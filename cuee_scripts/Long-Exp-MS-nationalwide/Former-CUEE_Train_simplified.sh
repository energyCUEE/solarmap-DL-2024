...
feature_type=S 
num_features=1 # อันนี้คือ จำนวน feature 

model_name=Informer 
seq_len=24 # อันนี้คือ จำนวน lag 
pred_len=4 # จำนวน prediction output samples
d_model=64 # จำนวน hidden dimension หนูเชคอันนี้จากการ run กับ validate set
