...
class DatasetCUEE(data.Dataset):
    ...
    def __read_data__(self): 
        ...
        for station_num in self.stations_list:
            ...
            data_x_list.append(data[border1:border2, :-1])  # data[border1:border2, -1] data[border1:border2]
            data_y_list.append(data[border1:border2, -1].reshape(-1,1))  # data[border1:border2,-1].reshape(-1,1)   data[border1:border2]
